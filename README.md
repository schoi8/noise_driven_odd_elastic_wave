...
**starfishmodel_noise_statistics_analysis** : analyze the statistics of noise in velocity from the starfish embryo model. At the end of the code, also analyze the statistics of randomly generated numbers that represent the velocity deviation in self-circling to verify the effect of finite time interval for velocity calculation on the statistics of noise in velocity.
